...
class _RatesScreenState extends ConsumerState<RatesScreen> {
  ...
  Future<void> _onUpdateRates() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            success ? 'Rates updated successfully' : 'Failed to update rates',
          ),
      ...
      children: [
              ...
              child: dataAsync.when(
                ...
                data: (currencies) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (_, index) =>
                        _RateItem(currency: filtered[index]),
                  );
                },
              ),
            ),
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            onPressed: _isUpdating ? null : _onUpdateRates,
